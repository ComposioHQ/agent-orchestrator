          ...
          >
            ...
            {Object.values(district.neighborhoods).map((neighborhood) => (
              <div
                ...
                className="absolute rounded-[18px] border border-[rgba(148,163,184,0.08)] bg-[rgba(15,23,42,0.28)]"
              ...
              >
                <div className="px-3 py-2 text-[10px] font-bold uppercase tracking-[0.14em] text-[rgba(148,163,184,0.72)]">
                  {neighborhood.label}
                </div>
              </div>
            ))}
