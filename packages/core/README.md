...
- `Agent` — AI coding tool adapter (claude-code, codex, aider, opencode, cursor, amp)
...
- agent-claude-code, agent-codex, agent-aider, agent-opencode, agent-cursor, agent-amp
