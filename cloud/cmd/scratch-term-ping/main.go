// Command scratch-term-ping measures end-to-end terminal echo latency against
// a cloud session's workspace shell. Temporary diagnostic — not shipped.
//
// Local usage:
//
//	AO_BASE=http://127.0.0.1:8081 AO_DEV_TOKEN=... AO_ORG=... AO_SESSION=... \
//	    go run ./cloud/cmd/scratch-term-ping
package main
