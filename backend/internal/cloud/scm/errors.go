...
var (
	...
	ErrInstallationNotOwned      = errors.New("cloud scm: installation is not accessible to the user")
	...
	ErrProviderRejected          = errors.New("cloud scm: github rejected the request")
)
