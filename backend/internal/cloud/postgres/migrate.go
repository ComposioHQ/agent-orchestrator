...
func grantRuntimeRole(ctx context.Context, databaseURL, runtimeRole string) error {
	...
	statements := []string{
		...
		"GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.ao_users, public.ao_auth_sessions, public.ao_organizations, public.ao_org_memberships, public.ao_cloud_workspaces TO " + role,
