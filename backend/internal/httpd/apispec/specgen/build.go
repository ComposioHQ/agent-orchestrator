...
var schemaNames = map[string]string{ //nolint:gosec // Public OpenAPI type names include reset-credit contracts; no credential value is stored here.
	...
	"ControllersKimiSubscriptionResponse":                 "KimiSubscriptionResponse",
	"ControllersKimiSubscriptionCapacityResponse":         "KimiSubscriptionCapacityResponse",
	"ControllersKimiSubscriptionLimitResponse":            "KimiSubscriptionLimitResponse",
...
func agentOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/kimi/subscription", id: "getKimiSubscription", tag: "agents",
			summary: "Read the active hosted Kimi Code subscription with a short daemon cache",
			resps:   []respUnit{{http.StatusOK, controllers.KimiSubscriptionResponse{}}, {http.StatusInternalServerError, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/kimi/subscription/refresh", id: "refreshKimiSubscription", tag: "agents",
			summary: "Refresh the active hosted Kimi Code subscription while bypassing the cache",
			resps:   []respUnit{{http.StatusOK, controllers.KimiSubscriptionResponse{}}, {http.StatusInternalServerError, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
