...
var schemaNames = map[string]string{
	...
	"ProjectClonePreflightInput":        "ClonePreflightInput",
	"ProjectClonePreflightResult":       "ClonePreflightResult",
...
func projectOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/projects/clone/preflight", id: "preflightProjectClone", tag: "projects",
			summary: "Resolve and validate a repository clone destination",
			reqBody: projectsvc.ClonePreflightInput{},
			resps: []respUnit{
				{http.StatusOK, projectsvc.ClonePreflightResult{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
			},
		},
