...
var schemaNames = map[string]string{
	...
	"ControllersBrowserObserveRequest":            "BrowserObserveRequest",
	"ControllersBrowserObserveResponse":           "BrowserObserveResponse",
	"ControllersBrowserActionRequest":             "BrowserActionRequest",
	"ControllersBrowserActionResult":              "BrowserActionResult",
	"ControllersBrowserActionResponse":            "BrowserActionResponse",
	"ControllersBrowserCommandRequest":            "BrowserCommandRequest",
	"ControllersBrowserCommandResponse":           "BrowserCommandResponse",
	"BrowserruntimeReadinessState":                "BrowserReadinessState",
	"BrowserruntimeTarget":                        "BrowserTarget",
	"BrowserruntimeImage":                         "BrowserImage",
	"BrowserruntimeElement":                       "BrowserElement",
	"BrowserruntimeSnapshot":                      "BrowserSnapshot",
	"BrowserruntimeLogEntry":                      "BrowserLogEntry",
	"BrowserruntimeProblems":                      "BrowserProblems",
	"BrowserruntimeLocator":                       "BrowserLocator",
	"BrowserruntimeExpectedState":                 "BrowserExpectedState",
	"BrowserruntimeActionWait":                    "BrowserActionWait",
	"BrowserruntimeActionState":                   "BrowserActionState",
	"BrowserruntimeActionEffects":                 "BrowserActionEffects",
	"BrowserruntimeActionEvidence":                "BrowserActionEvidence",
	"BrowserruntimeActionTarget":                  "BrowserActionTarget",
	"BrowserruntimeObservation":                   "BrowserObservation",
...
func browserOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/browser/observe", id: "observeBrowser", tag: "browser",
			summary:    "Observe the session browser with typed semantic and optional visual evidence",
			pathParams: []any{controllers.BrowserCapabilityHeader{}},
			reqBody:    controllers.BrowserObserveRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.BrowserObserveResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusForbidden, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/browser/actions", id: "executeBrowserAction", tag: "browser",
			summary:    "Execute a deterministic browser mutation with typed target preconditions",
			pathParams: []any{controllers.BrowserCapabilityHeader{}},
			reqBody:    controllers.BrowserActionRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.BrowserActionResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusForbidden, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
