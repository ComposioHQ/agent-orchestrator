...
var schemaNames = map[string]string{ //nolint:gosec // Public OpenAPI type names include reset-credit contracts; no credential value is stored here.
	...
	"ControllersClaudeCodeAccountsResponse":                 "ClaudeCodeAccountsResponse",
	"ControllersClaudeCodeAccountResponse":                  "ClaudeCodeAccountResponse",
	"ControllersClaudeCodePlanUsageResponse":                "ClaudeCodePlanUsageResponse",
	"ControllersClaudeCodePlanPromotionResponse":            "ClaudeCodePlanPromotionResponse",
	"ControllersClaudeCodePlanUsageWindowResponse":          "ClaudeCodePlanUsageWindowResponse",
	"ControllersClaudeCodeAccountIdentityResponse":          "ClaudeCodeAccountIdentityResponse",
	"ControllersClaudeCodeAuthenticationResponse":           "ClaudeCodeAuthenticationResponse",
	"ControllersClaudeCodeCapabilityObservationResponse":    "ClaudeCodeCapabilityObservationResponse",
	"ControllersClaudeCodeAccountCapabilitiesResponse":      "ClaudeCodeAccountCapabilitiesResponse",
	"ControllersClaudeCodeUnmanagedGlobalAccountResponse":   "ClaudeCodeUnmanagedGlobalAccountResponse",
	"ControllersClaudeCodeAccountLoginResponse":             "ClaudeCodeAccountLoginResponse",
	"ControllersClaudeCodeActiveLoginResponse":              "ClaudeCodeActiveLoginResponse",
	"ControllersClaudeCodeAccountLoginTerminalResponse":     "ClaudeCodeAccountLoginTerminalResponse",
	"ControllersOpenClaudeCodeAccountLoginTerminalResponse": "OpenClaudeCodeAccountLoginTerminalResponse",
	"ControllersStartClaudeCodeAccountSwitchRequest":        "StartClaudeCodeAccountSwitchRequest",
	"ControllersClaudeCodeAccountSwitchResponse":            "ClaudeCodeAccountSwitchResponse",
	"ControllersClaudeCodeAccountIDParam":                   "ClaudeCodeAccountIDParam",
	"ControllersClaudeCodeAccountLoginIDParam":              "ClaudeCodeAccountLoginIDParam",
	"ControllersClaudeCodeAccountSwitchIDParam":             "ClaudeCodeAccountSwitchIDParam",
...
func agentOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/claude-code/accounts", id: "getClaudeCodeAccounts", tag: "agents",
			summary: "Return cached AO Claude Code accounts and active-account state",
			resps:   []respUnit{{http.StatusOK, controllers.ClaudeCodeAccountsResponse{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/claude-code/accounts/ensure", id: "ensureClaudeCodeAccounts", tag: "agents",
			summary: "Reconcile the device Claude Code account catalog",
			resps:   []respUnit{{http.StatusOK, controllers.ClaudeCodeAccountsResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
		...
		{
			method: http.MethodPost, path: "/api/v1/agents/claude-code/accounts/{accountId}/login-terminal", id: "openClaudeCodeAccountReauthenticationTerminal", tag: "agents",
			summary: "Open isolated native Claude Code sign-in for one retained account", pathParams: []any{controllers.ClaudeCodeAccountIDParam{}},
			resps: []respUnit{{http.StatusAccepted, controllers.OpenClaudeCodeAccountLoginTerminalResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/claude-code/accounts/login-operations/{operationId}/verify", id: "verifyClaudeCodeAccountLogin", tag: "agents",
			summary: "Verify one isolated Claude Code account login operation", pathParams: []any{controllers.ClaudeCodeAccountLoginIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.ClaudeCodeAccountLoginResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
		...
		},
		{
			...
			summary: "Remove one Claude Code account credential from this device", pathParams: []any{controllers.ClaudeCodeAccountIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.ClaudeCodeAccountsResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/claude-code/accounts/events", id: "streamClaudeCodeAccounts", tag: "agents",
			summary:      "Stream cached and live Claude Code account state",
			resps:        []respUnit{{http.StatusOK, controllers.ClaudeCodeAccountsResponse{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
			contentTypes: map[int]string{http.StatusOK: "text/event-stream"},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/claude-code/account-switches", id: "startClaudeCodeAccountSwitch", tag: "agents",
			summary: "Start a device-global Claude Code account hot switch", reqBody: controllers.StartClaudeCodeAccountSwitchRequest{},
			resps: []respUnit{{http.StatusAccepted, controllers.ClaudeCodeAccountSwitchResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/claude-code/account-switches/{switchId}/recover", id: "recoverClaudeCodeAccountSwitch", tag: "agents",
			summary: "Recover one interrupted Claude Code account switch", pathParams: []any{controllers.ClaudeCodeAccountSwitchIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.ClaudeCodeAccountSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
