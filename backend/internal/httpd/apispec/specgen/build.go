...
var schemaNames = map[string]string{
	...
	"ControllersCodexProfileIDParam":                         "CodexProfileIDParam",
	"ControllersCodexProfileLoginIDParam":                    "CodexProfileLoginIDParam",
	...
	"ControllersStartCodexProfileSwitchRequest":              "StartCodexProfileSwitchRequest",
	"ControllersCodexProfileSwitchResponse":                  "CodexProfileSwitchResponse",
	"ControllersListCodexProfileSwitchesResponse":            "ListCodexProfileSwitchesResponse",
	"DomainCodexProfileSwitchOptions":                        "CodexProfileSwitchOptionsResponse",
	"DomainCodexProfileSwitch":                               "CodexProfileSwitch",
	"DomainCodexProfileSwitchCandidate":                      "CodexProfileSwitchCandidate",
	"DomainCodexAutomaticProfileSwitchPolicy":                "CodexAutomaticProfileSwitchPolicy",
	"DomainCodexAutomaticProfileSwitchPolicyEntry":           "CodexAutomaticProfileSwitchPolicyEntry",
	"DomainCodexAutomaticProfileSwitchAttempt":               "CodexAutomaticProfileSwitchAttempt",
	"DomainCodexAutomaticProfileSwitchAttemptCandidate":      "CodexAutomaticProfileSwitchAttemptCandidate",
	"ControllersPutCodexAutomaticProfileSwitchPolicyRequest": "PutCodexAutomaticProfileSwitchPolicyRequest",
	"DomainCodexSessionContinuationSummary":                  "CodexSessionContinuationSummary",
	...
	"ControllersEnsureCodexProfilesRequest":                  "EnsureCodexProfilesRequest",
	"ControllersEnsureCodexProfileCapacityRequest":           "EnsureCodexProfileCapacityRequest",
	"ControllersCreateCodexProfileRequest":                   "CreateCodexProfileRequest",
	...
	"AgentCodexProfileCapacityEvent":                         "CodexProfileCapacityEvent",
...
func agentOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/codex/profiles", id: "getCodexProfiles", tag: "agents",
			summary: "Return cached Codex profile discovery and authentication state",
			resps: []respUnit{
				{http.StatusOK, controllers.CodexProfilesResponse{}},
				{http.StatusServiceUnavailable, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/codex/profiles/ensure", id: "ensureCodexProfiles", tag: "agents",
			summary: "Discover Codex profiles and ensure their display authentication state",
			reqBody: controllers.EnsureCodexProfilesRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.CodexProfilesResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusServiceUnavailable, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/agents/codex/profiles/capacity/ensure", id: "ensureCodexProfileCapacity", tag: "agents",
			summary: "Ensure display capacity for selected Codex profiles",
			reqBody: controllers.EnsureCodexProfileCapacityRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.CodexProfilesResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusServiceUnavailable, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/agents/codex/profiles", id: "createCodexProfile", tag: "agents",
			summary: "Create an isolated AO-managed Codex profile",
			reqBody: controllers.CreateCodexProfileRequest{},
			resps: []respUnit{
		...
		{
			method: http.MethodPost, path: "/api/v1/agents/codex/profiles/{profileId}/login", id: "startCodexProfileLogin", tag: "agents",
			summary:    "Start browser authentication for one Codex profile",
			pathParams: []any{controllers.CodexProfileIDParam{}},
			resps: []respUnit{
				{http.StatusAccepted, controllers.StartCodexProfileLoginResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/codex/profiles/{profileId}/login/{operationId}/events", id: "streamCodexProfileLogin", tag: "agents",
			summary:    "Stream one in-memory Codex profile login operation",
			pathParams: []any{controllers.CodexProfileIDParam{}, controllers.CodexProfileLoginIDParam{}},
			resps: []respUnit{
				{http.StatusOK, ""},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusServiceUnavailable, envelope.APIError{}},
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/codex/profiles/capacity/events", id: "streamCodexProfileCapacity", tag: "agents",
			summary: "Stream cached and live Codex profile capacity",
			resps: []respUnit{
				{http.StatusOK, controllers.CodexProfileCapacityEventResponse{}},
				{http.StatusServiceUnavailable, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
			contentTypes: map[int]string{http.StatusOK: "text/event-stream"},
		...
		{
			method: http.MethodPost, path: "/api/v1/agents/codex/profiles/{profileId}/login/{operationId}/cancel", id: "cancelCodexProfileLogin", tag: "agents",
			summary:    "Cancel one pending Codex profile login operation",
			pathParams: []any{controllers.CodexProfileIDParam{}, controllers.CodexProfileLoginIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.CodexProfileLoginEventResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusServiceUnavailable, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/profile-switch-options", id: "getCodexProfileSwitchOptions", tag: "sessions",
			summary:    "Read cached assisted Codex profile-switch candidates",
			pathParams: []any{controllers.SessionIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchOptionsResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/profile-switch-options/ensure", id: "ensureCodexProfileSwitchOptions", tag: "sessions",
			summary:    "Refresh assisted Codex profile-switch candidates",
			pathParams: []any{controllers.SessionIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchOptionsResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/profile-switches", id: "startCodexProfileSwitch", tag: "sessions",
			summary:    "Start an explicitly confirmed assisted Codex profile switch",
			pathParams: []any{controllers.SessionIDParam{}}, reqBody: controllers.StartCodexProfileSwitchRequest{},
			resps: []respUnit{{http.StatusAccepted, controllers.CodexProfileSwitchResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/profile-switches", id: "listCodexProfileSwitches", tag: "sessions",
			summary:    "List durable Codex profile-switch operations",
			pathParams: []any{controllers.SessionIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.ListCodexProfileSwitchesResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/profile-switches/{switchId}", id: "getCodexProfileSwitch", tag: "sessions",
			summary:    "Read one durable Codex profile-switch operation",
			pathParams: []any{controllers.SessionIDParam{}, controllers.CodexProfileSwitchIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/profile-switches/{switchId}/cancel", id: "cancelCodexProfileSwitch", tag: "sessions",
			summary:    "Cancel an assisted switch before source shutdown",
			pathParams: []any{controllers.SessionIDParam{}, controllers.CodexProfileSwitchIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/profile-switches/{switchId}/recover", id: "recoverCodexProfileSwitch", tag: "sessions",
			summary:    "Retry the exact assisted-switch target",
			pathParams: []any{controllers.SessionIDParam{}, controllers.CodexProfileSwitchIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/profile-switches/{switchId}/restore-source", id: "restoreCodexProfileSwitchSource", tag: "sessions",
			summary:    "Restore the stopped predecessor when the target cannot continue",
			pathParams: []any{controllers.SessionIDParam{}, controllers.CodexProfileSwitchIDParam{}},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/profile-switches/{switchId}/handoff", id: "submitCodexProfileSwitchHandoff", tag: "sessions",
			summary:    "Submit a generation-fenced Codex profile-switch handoff",
			pathParams: []any{controllers.SessionIDParam{}, controllers.CodexProfileSwitchIDParam{}},
			reqBody:    controllers.SubmitAgentHandoffRequest{},
			resps:      []respUnit{{http.StatusOK, controllers.CodexProfileSwitchResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusInternalServerError, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/automatic-profile-switch-policy", id: "getCodexAutomaticProfileSwitchPolicy", tag: "sessions",
			summary: "Read the cached continuation-chain automatic switching policy", pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.CodexAutomaticProfileSwitchPolicyResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPut, path: "/api/v1/sessions/{sessionId}/automatic-profile-switch-policy", id: "putCodexAutomaticProfileSwitchPolicy", tag: "sessions",
			summary: "Replace the ordered continuation-chain automatic switching policy", pathParams: []any{controllers.SessionIDParam{}}, reqBody: controllers.PutCodexAutomaticProfileSwitchPolicyRequest{},
			resps: []respUnit{{http.StatusOK, controllers.CodexAutomaticProfileSwitchPolicyResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/automatic-profile-switch-attempts/{attemptId}/cancel", id: "cancelCodexAutomaticProfileSwitchAttempt", tag: "sessions",
			summary: "Cancel automatic evaluation before the linked switch becomes unsafe", pathParams: []any{controllers.SessionIDParam{}, controllers.CodexAutomaticProfileSwitchAttemptIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.CodexAutomaticProfileSwitchAttemptResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
