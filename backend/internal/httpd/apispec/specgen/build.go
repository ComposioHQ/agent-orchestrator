...
var schemaNames = map[string]string{
	...
	"ControllersUsageTurn":                        "UsageTurn",
	"ControllersUsageSummary":                     "UsageSummary",
	"ControllersRecordUsageRequest":               "RecordUsageRequest",
	"ControllersRecordUsageResponse":              "RecordUsageResponse",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/usage", id: "recordSessionUsage", tag: "sessions",
			summary:    "Report agent token usage for a session",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.RecordUsageRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.RecordUsageResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
