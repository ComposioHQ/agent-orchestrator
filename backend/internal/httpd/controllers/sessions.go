...
func (c *SessionsController) Register(r chi.Router) {
	...
	r.Get("/sessions/{sessionId}/profile-switch-options", c.codexProfileSwitchOptions)
	r.Post("/sessions/{sessionId}/profile-switch-options/ensure", c.ensureCodexProfileSwitchOptions)
	r.Post("/sessions/{sessionId}/profile-switches", c.startCodexProfileSwitch)
	r.Get("/sessions/{sessionId}/profile-switches", c.listCodexProfileSwitches)
	r.Get("/sessions/{sessionId}/profile-switches/{switchId}", c.getCodexProfileSwitch)
	r.Post("/sessions/{sessionId}/profile-switches/{switchId}/cancel", c.cancelCodexProfileSwitch)
	r.Post("/sessions/{sessionId}/profile-switches/{switchId}/recover", c.recoverCodexProfileSwitch)
	r.Post("/sessions/{sessionId}/profile-switches/{switchId}/restore-source", c.restoreCodexProfileSwitchSource)
	r.Post("/sessions/{sessionId}/profile-switches/{switchId}/handoff", c.submitCodexProfileSwitchHandoff)
	r.Get("/sessions/{sessionId}/automatic-profile-switch-policy", c.codexAutomaticProfileSwitchPolicy)
	r.Put("/sessions/{sessionId}/automatic-profile-switch-policy", c.putCodexAutomaticProfileSwitchPolicy)
	r.Post("/sessions/{sessionId}/automatic-profile-switch-attempts/{attemptId}/cancel", c.cancelCodexAutomaticProfileSwitchAttempt)
