-- +goose Up
-- Persist only a redacted provider-owned startup prompt class. Rendered pane
-- text and choices remain ephemeral and never enter SQLite or the CDC stream.
ALTER TABLE sessions ADD COLUMN startup_prompt TEXT NOT NULL DEFAULT '';
...
WHEN OLD.activity_state <> NEW.activity_state
    ...
    OR OLD.startup_prompt <> NEW.startup_prompt
...
BEGIN
    ...
    VALUES (NEW.project_id, NEW.id, 'session_updated',
        json_object(
            ...
            'startupPrompt', NEW.startup_prompt,
...
ALTER TABLE sessions DROP COLUMN startup_prompt;
