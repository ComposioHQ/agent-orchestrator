...
INSERT INTO sessions (
    ...
    created_at, updated_at, is_pinned, pinned_at, auto_inject_review, auto_inject_ci, context_pressure
) VALUES (
    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
...
UPDATE sessions SET
    ...
    is_pinned = ?, pinned_at = ?, auto_inject_review = ?, auto_inject_ci = ?, context_pressure = ?
WHERE id = ?;
