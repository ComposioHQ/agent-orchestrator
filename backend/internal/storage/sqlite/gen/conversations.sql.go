...
SELECT b.id, b.conversation_id, b.session_id, b.review_id, b.provider_conversation_id, b.parent_branch_id, b.fork_after_turn_id, b.replaced_turn_id, b.replacement_turn_id, b.fork_after_sequence, b.created_at, b.id = c.active_branch_id AS active,
       CAST(COALESCE((
           SELECT lineage.id
           FROM lineage
...
WITH RECURSIVE active_path(branch_id, max_sequence, depth) AS (
    ...
    SELECT branch.id, branch.conversation_id, branch.session_id, branch.review_id, branch.provider_conversation_id, branch.parent_branch_id, branch.fork_after_turn_id, branch.replaced_turn_id, branch.replacement_turn_id, branch.fork_after_sequence, branch.created_at
...
SELECT id, conversation_id, handled_by_session_id, handled_by_review_id, provider_turn_id, controller_generation, state, error_message, requested_at, started_at, completed_at, diff_json, rolled_back_at, plan_json, branch_id, promotion_started_at, promoted_to_turn_id FROM conversation_turns WHERE id = ? LIMIT 1
`
...
SELECT id, conversation_id, handled_by_session_id, handled_by_review_id, provider_turn_id, controller_generation, state, error_message, requested_at, started_at, completed_at, diff_json, rolled_back_at, plan_json, branch_id, promotion_started_at, promoted_to_turn_id FROM conversation_turns
