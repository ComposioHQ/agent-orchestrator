...
func TestSQLiteProductFactsConformance(t *testing.T) {
	...
	storagetest.RunProductFactsConformance(t, context.Background(), storagetest.ProductFactsFixture{Store: store, ProjectID: first.ProjectID, SessionID: first.ID, OtherSessionID: second.ID})
}
