...
// The provider detail tables were the shape 0105 replaced with one bounded
...
// TestUsageMeasurementMigrationFoldsCostsAndRetiresDetailTables covers 0105
// directly: a pre-0105 profile is seeded through the migrations that shipped
