...
// CDC is intentionally absent: database triggers own change capture, while
// product stores perform only canonical fact mutations.
...
// RunProductFactsConformance verifies SCM facts/actions, notification behavior,
// derived-status inputs, and deterministic replacement semantics.
