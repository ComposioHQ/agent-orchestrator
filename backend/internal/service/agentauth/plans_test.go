...
func TestPlansMatchAuthenticationMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"pi", "Log in to Pi", "pi", "Select Open login after Pi finishes starting", "https://github.com/earendil-works/pi", "/login\r", ActionLogin, []string{"pi", "--verbose"}},
		...
		{"qwen", "Set up Qwen", "qwen", "Select Open login after Qwen finishes starting", "https://qwenlm.github.io/qwen-code-docs/en/users/configuration/auth/", "i\x7f/auth\r", ActionSetup, []string{"qwen"}},
