...
func (s *Service) Start(ctx context.Context, cfg StartConfig) (*Controller, error) {
	...
	controller := newController(
		cfg.SessionID, owner, cfg.WorkspaceAccess, conversation, generation, cfg.Harness, conv, s.store, s.activity, s.log, s.newID, s.now, s.onAccountChanged, s.onCodexCapacityChanged)
