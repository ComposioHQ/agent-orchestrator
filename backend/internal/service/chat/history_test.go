...
func newEditHarness(t *testing.T, supportsPromptReplay bool) (*harness, *historyRecorder, *editDriverState) {
	return newEditHarnessWithOptions(t, supportsPromptReplay, nil, nil)
}
...
func newEditHarnessWithAccount(
	...
	return newEditHarnessWithOptions(t, supportsPromptReplay, initialAccount, nil)
}
...
func newEditHarnessWithControllerEnv(
	...
	return newEditHarnessWithOptions(t, supportsPromptReplay, nil, prepare)
}
...
func TestEditMessageReplacementDoesNotResurrectClearedReauthState(t *testing.T) {
	...
	h, _, driver := newEditHarnessWithAccount(t, false, &domain.ConversationAccount{
