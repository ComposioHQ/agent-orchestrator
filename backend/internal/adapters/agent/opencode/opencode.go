...
// NativeConversationID bridges OpenCode's terminal --session id and ACP
// session id. Both surfaces address the same native OpenCode session; a TUI
// source must have reported it through the AO activity plugin before switching.
