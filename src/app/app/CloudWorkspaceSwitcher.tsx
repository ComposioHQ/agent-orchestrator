  ...
  return (
    <div ref={rootRef} className="relative mx-2 mb-2 mt-3">
      <motion.button
        ...
        className="flex h-9 w-full cursor-pointer items-center gap-2 rounded-lg bg-[var(--muted)] px-2.5 text-left text-sm font-normal text-[var(--muted-foreground)] transition-[background-color,color] duration-150 ease-out hover:bg-[var(--color-interactive-hover)] hover:text-[var(--foreground)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] motion-reduce:transition-none"
