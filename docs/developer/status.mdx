---
title: "agent-orchestrator status"
---
...
top-level [`README.md`](../README); for the backend mental model see
...
See [`AGENTS.md`](../AGENTS) for the regen workflow when touching the API
