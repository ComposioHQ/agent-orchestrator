...
| [design/cloud-integration.md](design/cloud-integration.md) | Evidence-backed local/cloud integration architecture and staged migration plan.                                      |
| [cloud/deployment.md](cloud/deployment.md)             | AWS, Google auth, Daytona, secret custody, migration-first deployment, and operations.                              |
