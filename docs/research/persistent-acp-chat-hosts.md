...
11. **Branch activation:** ADR 0003 documents a bounded Codex migration gap during branch replacement. Decide whether ACP hosts can transfer/adopt safely or should retain the same launch-before-destroy fallback.
