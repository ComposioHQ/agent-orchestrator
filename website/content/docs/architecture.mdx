...
For storage details, see [Storage — PATH Wrappers](/docs/configuration/storage#path-wrappers).
...
<Cards>
  ...
  <Card title="Storage" href="/docs/configuration/storage" description="Understand where AO stores session metadata, worktrees, archives, and PATH wrappers." />
</Cards>
