...
For more on where AO stores session data and secrets, see [Storage](/docs/configuration/storage).
...
- [Storage](/docs/configuration/storage) — data directory layout and session files
