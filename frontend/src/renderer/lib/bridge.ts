...
export const aoBridge: AoBridge =
	...
	({
		...
		cloud: {
			...
			getOverview: async () => { throw new Error("AO Cloud is unavailable in the web preview."); },
			...
			openTerminal: async () => { throw new Error("AO Cloud is unavailable in the web preview."); },
