			...
			sessions: (sessionsData?.sessions ?? [])
				...
				.map((session) => {
					...
					return {
						...
						continuedTo: session.continuedTo,
						activeCodexProfileSwitch: session.activeCodexProfileSwitch ? {
							id: session.activeCodexProfileSwitch.id,
							phase: session.activeCodexProfileSwitch.phase,
							progressReason: session.activeCodexProfileSwitch.progressReason,
							targetSessionId: session.activeCodexProfileSwitch.targetSessionId,
							targetProfileId: session.activeCodexProfileSwitch.targetProfileId,
							canCancel: session.activeCodexProfileSwitch.canCancel,
							canRecover: session.activeCodexProfileSwitch.canRecover,
							canRestoreSource: session.activeCodexProfileSwitch.canRestoreSource,
							errorCode: session.activeCodexProfileSwitch.errorCode,
						} : undefined,
						latestAutomaticCodexProfileSwitchAttempt: session.latestAutomaticCodexProfileSwitchAttempt ? {
							id: session.latestAutomaticCodexProfileSwitchAttempt.id,
							state: session.latestAutomaticCodexProfileSwitchAttempt.state,
							trigger: session.latestAutomaticCodexProfileSwitchAttempt.trigger,
							outcomeCode: session.latestAutomaticCodexProfileSwitchAttempt.outcomeCode,
							reason: session.latestAutomaticCodexProfileSwitchAttempt.reason,
							canCancel: session.latestAutomaticCodexProfileSwitchAttempt.canCancel,
							targetProfile: session.latestAutomaticCodexProfileSwitchAttempt.targetProfile,
							profileSwitch: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch ? {
								id: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.id,
								phase: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.phase,
								progressReason: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.progressReason,
								targetSessionId: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.targetSessionId,
								targetProfileId: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.targetProfileId,
								canCancel: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.canCancel,
								canRecover: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.canRecover,
								canRestoreSource: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.canRestoreSource,
								errorCode: session.latestAutomaticCodexProfileSwitchAttempt.profileSwitch.errorCode,
							} : undefined,
						} : undefined,
