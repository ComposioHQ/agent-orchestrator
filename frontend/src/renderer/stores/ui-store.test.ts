...
// emulatorEnabled initializes from localStorage at module load, same as
// developerMode above — each case resets modules and re-imports to exercise
// the real initialization path.
