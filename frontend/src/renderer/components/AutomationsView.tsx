...
export function AutomationsView() {
	...
	return (
		<div className="flex min-h-0 flex-1 flex-col overflow-auto bg-background">
			...
			<CreateAutomationDialog open={createOpen} workspaces={workspaces} busy={create.isPending} error={create.error?.message ?? null} onOpenChange={setCreateOpen} onCreate={async (input) => { await create.mutateAsync(input); setCreateOpen(false); }} />
