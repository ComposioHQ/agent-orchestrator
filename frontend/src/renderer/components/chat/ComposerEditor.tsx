				...
				<PlainTextPlugin
					contentEditable={
						<ContentEditable
							...
							className={cn(
								"chat-composer-scrollbar max-h-40 min-h-[4.5rem] w-full overflow-y-auto overscroll-contain bg-transparent py-1 pl-[7px] pr-0 text-base! leading-relaxed text-foreground caret-foreground outline-none selection:bg-primary/45",
								disabled && "opacity-50",
							)}
						/>
					}
