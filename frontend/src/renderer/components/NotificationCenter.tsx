		...
		<Popover onOpenChange={setPanelOpen} open={open}>
			<PopoverTrigger asChild>
				...
				>
					...
					{unreadCount > 0 ? (
						<span className="pointer-events-none absolute -right-0.5 -top-0.5 grid min-w-4 place-items-center rounded-full bg-error px-1 font-mono text-[9px] font-semibold leading-4 text-background shadow-sm">
