	...
	return (
		<SwitchPrimitive.Root
			...
			className={cn(
				...
				size === "compact" ? "h-4 w-7 border transition-none" : size === "sm" ? "h-4 w-8 border" : "h-5 w-11 border-2",
				className,
			)}
			{...props}
		>
			<SwitchPrimitive.Thumb
				...
				className={cn(
					...
					size === "compact"
						? "size-3 transition-transform duration-150 ease-out data-[state=unchecked]:translate-x-0.5 data-[state=checked]:translate-x-3"
						: size === "sm"
