...
If you launch the app with `ao start` from a terminal and tmux is missing, it offers to run this for you.
...
If you launch the app with `ao start` from a terminal and tmux is missing, it offers to install it for you with
`apt-get`, `dnf`, `pacman`, `zypper`, or `apk`.
