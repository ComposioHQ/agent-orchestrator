...
Cloud UI, chat/event handlers, workers, terminal/files, GitHub behavior, sharing
behavior, and deployment are intentionally not implemented yet.
...
exercises local and WorkOS-backed principals, checks idempotent project/session
creation, and proves cross-organization reads are denied.
